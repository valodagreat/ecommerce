...
export const login = (email,password) => async(dispatch) => {
    try {
        ...
        const {data} = await instance.post(`/api/users/login`,{email, password}, config)
...
export const register = (name, email, password) => async(dispatch) => {
    try {
        ...
        const {data} = await instance.post(`/api/users`,{name,email, password}, config)
